      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Board Members</h2>
            <p className="text-xl text-gray-400">The Board of Applied Engineering Club is the Steering Committee responsible for leading the club.</p>
            <h4 className="h4 mt-4">Board Members for Spring 2023</h4>
          </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              <div>
                ...
                <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                  <cite className="text-gray-200 not-italic">Raymond Chbeir</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">President</a>
                </div>
              </div>
