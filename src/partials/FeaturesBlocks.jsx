      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Our Recent Projects</h2>
            <p className="text-xl text-gray-400">Click on any project to learn more about it.</p>
          </div>
            ...
            <div className="relative flex flex-col items-center"  data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <rect className="fill-current text-purple-600" width="64" height="64" rx="32" />
										<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-rocket" x="37%" y="37%" dominant-baseline="middle" text-anchor="middle" viewBox="0 0 40 40">
              ...
              <h4 className="h4 mb-2">Project Iris</h4>
              <p className="text-lg text-gray-400 text-center">A model rocket that lands vertically.</p>
            </div>
